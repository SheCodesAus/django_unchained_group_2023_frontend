        ...
        <div className="feature1__container">
          <div className="split">
            ...
            <div className="right-normaliser-1">
              ...
              <p className="body">
                Our built-in dashboard shows valuable insights and monitor the
                best prices.
              </p>
            </div>
          </div>
        ...
        <div class="feature2__container">
          <div class="split">
            <div class="left-normaliser-2">
              <h2 class="subheading">
                analytics to justify your retail therapy
              </h2>
              <h1 class="h1">Data that backs you up</h1>
              <p class="body">
                Never have to justify why you just buy (thing) when you have
                perfectly good (thing) at home. We show you all important data
                you need to convince people that you do not have a shopping
                problem but really a savvy saver.{" "}
              </p>
            </div>
            <div class="two-right">
              <img
        ...
        <div class="feature3__container">
          <div class="split">
            ...
            <div class="right-normaliser-3">
              ...
              <p class="body">
                Naughty or nice? 🎅 Doesn't matter, we let you check your lists
                twice. Keep track of your favourite items, strikeout things you
                don't want and (our personal favourite) share your lists with
                your friends and family (to subtly convince them to buy it for
                you - the ultimate savings).{" "}
              </p>
            </div>
          </div>
        </div>
